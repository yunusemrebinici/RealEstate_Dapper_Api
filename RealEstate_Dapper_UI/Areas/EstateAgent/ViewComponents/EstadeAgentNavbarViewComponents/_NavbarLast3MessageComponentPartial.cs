...
namespace RealEstate_Dapper_UI.Areas.EstateAgent.ViewComponents.EstadeAgentNavbarViewComponents
{
    public class _NavbarLast3MessageComponentPartial:ViewComponent
    {
        ...
        public async Task< IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:44388/api/Message?id="+id);
